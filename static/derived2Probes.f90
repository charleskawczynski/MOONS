       ...
       contains
        ...
        subroutine initializeCenterProbe(p,dir,name,TF_freshStart,s,gd)
          ...
          call initialize(p%ip,gd,s,(s+1)/2,dir,name,TF_freshStart)
        end subroutine
        ...
        subroutine initializeAveProbe(p,dir,name,TF_freshStart,s,i,gd,component)
          ...
          write(*,*) 'Initializing aveProbe:'
          call initialize(p%ip,gd,s,i,dir,name,TF_freshStart)
        ...
        subroutine initializePlaneErrorProbe(p,dir,name,TF_freshStart,s,i,gd,direction)
          ...
          write(*,*) 'planeError h = ',h
          write(*,*) 'planeError p%h = ',p%h
          p%h = h(direction)
        end subroutine
