       ...
       !                                      2 : Fringing Magnetic field (Sergey's fringe)
       ...
       subroutine initPreDefinedB0(Bx,By,Bz,g)
         ...
         case (2); call initFringingField(Bx,By,Bz,g,applied_B_dir,fringe_dir)
       ...
       subroutine initFringingField(Bx,By,Bz,g,dir,fringeDir)
         implicit none
         type(grid),intent(in) :: g
         real(cp),dimension(:,:,:),intent(inout) :: Bx,By,Bz
         integer,intent(in) :: dir,fringeDir
         select case (dir)
         case (1); call initFringe(Bx,g,fringeDir)
         case (2); call initFringe(By,g,fringeDir)
         case (3); call initFringe(Bz,g,fringeDir)
         case default
         stop 'Error: dir must = 1,2,3 in initFringingField.'
         end select
       end subroutine
       ...
       subroutine initFringe(B0,g,dir)
         implicit none
         type(grid),intent(in) :: g
