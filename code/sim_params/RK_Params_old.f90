       ...
       interface update_time;   module procedure update_time_RKP_TMP;   end interface
       ...
       subroutine update_time_RKP_TMP(RKP,TMP)
         implicit none
         type(RK_Params),intent(in) :: RKP
         ...
         call insist_allocated(RKP)
#endif
         TMP%t = TMP%t + RKP%c(RKP%n)*TMP%dt
       end subroutine

       subroutine update_stage_RKP(RKP,TMP)
         implicit none
         type(RK_Params),intent(inout) :: RKP
         ...
         call insist_allocated(RKP)
#endif
         ! RKP%n = mod(TMP%n_step-TMP%n_step_first,RKP%RK_order)+1
         RKP%n = mod(int(TMP%n_step)-0,RKP%RK_order)+1
       end subroutine
