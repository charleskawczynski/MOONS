     ...
     subroutine sim_params_init_solver_config(SP)
       ...
       call init(SP%VS%P%ISP,  20 ,pow(-6),pow(-13),1,F,SP%FCL%export_heavy)
       call init(SP%VS%B%ISP,  20 ,pow(-6),pow(-13),1,F,SP%FCL%export_heavy)
       call init(SP%VS%B0%ISP, 5  ,pow(-6),pow(-13),1,F,SP%FCL%export_heavy)
       call init(SP%VS%phi%ISP,20 ,pow(-6),pow(-13),1,F,SP%FCL%export_heavy)
