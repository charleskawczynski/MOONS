       ...
       subroutine Ln_mesh_SF(e,u,n,m)
         ...
         e = 0.0_cp
         do t=1,m%s
          call compute_Ln_norm(temp,u%BF(t)%GF,n,m%B(t)%vol(vol_ID(u%DL)))
          e = e + temp
         enddo
       end subroutine
       ...
       subroutine Ln_mesh_VF(e,u,n,m)
         ...
         if (is_collocated(u)) then
           ...
           do t=1,m%s;
             call compute_Ln_norm(temp,u%x%BF(t)%GF,n,m%B(t)%vol(vol_ID(u%x%DL))); e = e + temp
             call compute_Ln_norm(temp,u%y%BF(t)%GF,n,m%B(t)%vol(vol_ID(u%y%DL))); e = e + temp
             call compute_Ln_norm(temp,u%z%BF(t)%GF,n,m%B(t)%vol(vol_ID(u%z%DL))); e = e + temp
           enddo
         endif
       end subroutine
