     ...
     subroutine init_SP(SP,DT)
       ...
       call init(SP%VS%T%ISP,  1000 ,pow(-5),pow(-7) ,100,str(DT%ISP),'ISP_T')
       call init(SP%VS%U%ISP,  1000 ,pow(-5),pow(-7) ,100,str(DT%ISP),'ISP_U')
       call init(SP%VS%P%ISP,  10   ,pow(-7),pow(-12),100,str(DT%ISP),'ISP_P')
       call init(SP%VS%B%ISP,  10000,pow(-5),pow(-7) ,100,str(DT%ISP),'ISP_B')
       call init(SP%VS%B0%ISP, 1000 ,pow(-5),pow(-7) ,100,str(DT%ISP),'ISP_B0')
       call init(SP%VS%phi%ISP,5    ,pow(-7),pow(-12),100,str(DT%ISP),'ISP_phi')
