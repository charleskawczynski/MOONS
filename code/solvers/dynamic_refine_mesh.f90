       ...
       subroutine dynamic_refine_mesh(nrg,mom,ind,DT,SP,coupled,sc,F,PE,RM,KS,&
         ...
         if (SP%BMC%VS%T%SS%solve) then; steady_solution(1) = steady(nrg%probe_divQ)
         else;                           steady_solution(1) = .true.;endif
         if (SP%BMC%VS%U%SS%solve) then; steady_solution(2) = steady(mom%probe_KE)
         else;                           steady_solution(2) = .true.;endif
         if (SP%BMC%VS%B%SS%solve) then; steady_solution(3) = steady(ind%ME_fluid(3))
         else;                           steady_solution(3) = .true.;endif
         if (SP%BMC%VS%B%SS%solve) then; steady_solution(4) = steady(ind%JE_fluid)
         ...
         if (SP%BMC%VS%T%SS%solve) then; steady_solution(1) = steady_final(nrg%probe_divQ)
         else;                           steady_solution(1) = .true.;endif
         if (SP%BMC%VS%U%SS%solve) then; steady_solution(2) = steady_final(mom%probe_KE)
         else;                           steady_solution(2) = .true.;endif
         if (SP%BMC%VS%B%SS%solve) then; steady_solution(3) = steady_final(ind%ME_fluid(3))
         else;                           steady_solution(3) = .true.;endif
         if (SP%BMC%VS%B%SS%solve) then; steady_solution(4) = steady_final(ind%JE_fluid)
         else;                           steady_solution(4) = .true.;endif
