      ...
      subroutine defineDinv(JAC)
        ...
        call apply_stitches(JAC%Dinv,JAC%m)
...
! #endif
        ...
        do while (continueLoop.and.TF)
          ...
          call export_3D_1C(m,JAC%Au,'out/LDC/Ufield/','Au',0)
          call subtract(JAC%res,f,JAC%Au)
          call multiply(u,JAC%Dinv,JAC%res)
          call export_3D_1C(m,JAC%Au,'out/LDC/Ufield/','Res',0)
          call export_3D_1C(m,JAC%Dinv,'out/LDC/Ufield/','Dinv',0)
