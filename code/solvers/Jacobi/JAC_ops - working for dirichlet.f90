      ...
      type JACSolver
        type(grid) :: g ! grid
        type(SF) :: lapu,res,Dinv ! laplacian, residual, coefficient
      ...
      subroutine solveJAC(JAC,u,f,g,ss,norm,displayTF)
        ...
        do while (continueLoop.and.TF)
          ijk = ijk + 1
          call d%assign_T(JAC%lapu,u,g,JAC%LU(1),1,1) ! LU_x
          call d%add_T   (JAC%lapu,u,g,JAC%LU(2),2,1) ! LU_y
          call d%add_T   (JAC%lapu,u,g,JAC%LU(3),3,1) ! LU_z
