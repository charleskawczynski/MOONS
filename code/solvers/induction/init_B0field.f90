       ...
       subroutine init0Bfield(B,m,restartB,restartB0,dir)
         implicit none
         ...
         case (3);
         case (4);
         case default; stop 'Error: preDefinedB0_ICs must = 1:5 in initB0field in init_B0field.f90.'
         end select
