       ...
       subroutine make_restart_dir_time_statistics_VF(this,dir)
         ...
         call make_restart_dir(this%stresses,dir//'stresses'//fortran_PS)
       ...
       subroutine export_restart_time_statistics_VF(this,dir)
         ...
         call export_restart(this%stresses,dir//'stresses'//fortran_PS)
         call export_restart(this%stresses_sum,&
         dir//'stresses_sum'//fortran_PS)
         call export_restart(this%L2_stresses,dir//'L2_stresses'//fortran_PS)
       ...
       subroutine import_restart_time_statistics_VF(this,dir)
         ...
         call import_restart(this%stresses,dir//'stresses'//fortran_PS)
         call import_restart(this%stresses_sum,&
         dir//'stresses_sum'//fortran_PS)
         call import_restart(this%L2_stresses,dir//'L2_stresses'//fortran_PS)
