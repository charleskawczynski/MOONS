       ...
       interface export_restart;   module procedure export_restart_single_procedure;   end interface
       interface import;           module procedure import_single_procedure;           end interface
       interface import_restart;   module procedure import_restart_single_procedure;   end interface
       ...
       interface make_restart_dir; module procedure make_restart_dir_single_procedure; end interface
       ...
       subroutine export_restart_single_procedure(this,dir)
         implicit none
         type(single_procedure),intent(in) :: this
       ...
       subroutine import_restart_single_procedure(this,dir)
         implicit none
         type(single_procedure),intent(inout) :: this
         character(len=*),intent(in) :: dir
         integer :: un
       ...
       subroutine make_restart_dir_single_procedure(this,dir)
         implicit none
         type(single_procedure),intent(in) :: this
         character(len=*),intent(in) :: dir
