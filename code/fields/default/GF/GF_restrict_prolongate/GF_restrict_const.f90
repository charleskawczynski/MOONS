       ...
       private
       public :: restrict_C_const
       public :: restrict_N_const
       interface restrict_C_const;    module procedure restrict_C_GF;         end interface
       interface restrict_C_const;    module procedure restrict_C_reset_GF;   end interface
       interface restrict_N_const;    module procedure restrict_N_GF;         end interface
       interface restrict_N_const;    module procedure restrict_N_reset_GF;   end interface
       ...
       subroutine restrict_C_reset_GF(u,g,dir,x,y,z)
         ...
         call restrict_C_const(temp,u,g,dir,x,y,z)
         call init(u,temp)
         call assign(u,temp)
         call delete(temp)
       end subroutine
       ...
       subroutine restrict_N_reset_GF(u,g,dir,x,y,z)
         ...
         call init(temp,u%s/(eye_given_dir(dir)+1))
         call assign(temp,0.0_cp)
         call restrict_N_const(temp,u,g,dir,x,y,z)
         call init(u,temp)
         call assign(u,temp)
         call delete(temp)
       end subroutine
