      module RF_subtract_mod
      use RF_mod
      implicit none
      private

      public :: subtract
      public :: subtract_face
      public :: subtract_edge
      ...
      interface subtract;        module procedure SF_SF;           end interface
      interface subtract;        module procedure SF_SF_SF;        end interface
      interface subtract;        module procedure SF_S_SF;         end interface
      interface subtract;        module procedure SF_S;            end interface
      interface subtract;        module procedure S_SF;            end interface
      ...
      interface subtract;        module procedure VF_VF_SF;        end interface
      interface subtract;        module procedure VF_S_VF;         end interface
      interface subtract;        module procedure VF_S;            end interface
      interface subtract;        module procedure S_VF;            end interface

      interface subtract_face;   module procedure face_VF_VF;      end interface
      interface subtract_face;   module procedure face_VF_SF;      end interface
      interface subtract_face;   module procedure face_VF_VF_VF;   end interface
      interface subtract_face;   module procedure face_VF_VF_SF;   end interface
      interface subtract_face;   module procedure face_VF_S_VF;    end interface
      interface subtract_face;   module procedure face_VF_S;       end interface
      interface subtract_face;   module procedure face_S_VF;       end interface

      interface subtract_edge;   module procedure edge_VF_VF;      end interface
      interface subtract_edge;   module procedure edge_VF_SF;      end interface
      interface subtract_edge;   module procedure edge_VF_VF_VF;   end interface
      interface subtract_edge;   module procedure edge_VF_VF_SF;   end interface
      interface subtract_edge;   module procedure edge_VF_S_VF;    end interface
      interface subtract_edge;   module procedure edge_VF_S;       end interface
      interface subtract_edge;   module procedure edge_S_VF;       end interface
