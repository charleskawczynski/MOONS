      ...
      include 'includes/VF_assign_int.f90'
      include 'includes/VF_assign_negative_int.f90'
      include 'includes/VF_add_int.f90'
      include 'includes/VF_subtract_int.f90'
      include 'includes/VF_multiply_int.f90'
      include 'includes/VF_divide_int.f90'
      include 'includes/VF_aux_int.f90'

      contains

      include 'includes/VF_assign.f90'
      include 'includes/VF_assign_negative.f90'
      include 'includes/VF_add.f90'
      include 'includes/VF_subtract.f90'
      include 'includes/VF_multiply.f90'
      include 'includes/VF_divide.f90'
      include 'includes/VF_aux.f90'
