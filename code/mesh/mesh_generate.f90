       ...
       subroutine mesh_generate(m_mom,m_ind,MD_sigma,Ha,tw,include_vacuum)
         implicit none
         ...
         real(cp) :: suppress_warning_cp
         logical :: suppress_warning_logical
         suppress_warning_logical = include_vacuum
