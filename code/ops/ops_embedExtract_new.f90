       ...
       subroutine embedExtract_RF(A,B,AB,i_1,i_2)
         ! This is the embed/extract (EE) routine.
         implicit none
         type(realField),intent(inout) :: A
         type(realField),intent(in) :: B
         ...
         call embedExtract_RF_raw(A,B,(/AB(1)%i1(i_1),AB(2)%i1(i_1),AB(3)%i1(i_1)/),&
                                      (/AB(1)%i1(i_2),AB(2)%i1(i_2),AB(3)%i1(i_2)/),&
                                      (/AB(1)%i2(i_1),AB(2)%i2(i_1),AB(3)%i2(i_1)/),&
                                      (/AB(1)%i2(i_2),AB(2)%i2(i_2),AB(3)%i2(i_2)/))
         ! maybe this? call embedExtract_RF_raw(A,B,AB(1:3)%i1(i_1),&
         ! maybe this?                              AB(1:3)%i1(i_2),&
         ! maybe this?                              AB(1:3)%i2(i_1),&
         ! maybe this?                              AB(1:3)%i2(i_2))
       end subroutine
