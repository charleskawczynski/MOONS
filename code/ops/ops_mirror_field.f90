       ...
       subroutine mirror_field_SF(m_mirror,x_mirror,m,x,face,mirror_sign)
         ...
         if (min_face(face)) then
          call mirror_about_hmin(m_mirror,d)
          call mirror_about_hmin(x_mirror,d,mirror_sign)
         endif
         if (max_face(face)) then
          call mirror_about_hmax(m_mirror,d)
          call mirror_about_hmax(x_mirror,d,mirror_sign)
         endif
       end subroutine
