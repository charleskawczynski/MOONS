      ...
      subroutine init_dataSet(DS,g,U,directory,name,dim)
        implicit none
      ...
      subroutine init_name(DS,directory,name)
        ! Defines
        ...
        allocate(DS%var(3))
        call init(DS%var(1),name//'_x')
        call init(DS%var(2),name//'_y')
        call init(DS%var(3),name//'_z')
