      module RF_multiply_mod
      use RF_mod
      implicit none
      private

      public :: multiply
      public :: multiply_face
      public :: multiply_edge
      ...
      interface multiply;        module procedure SF_SF;           end interface
      interface multiply;        module procedure SF_SF_SF;        end interface
      interface multiply;        module procedure SF_S_SF;         end interface
      interface multiply;        module procedure SF_S;            end interface
      interface multiply;        module procedure S_SF;            end interface

      interface multiply;        module procedure VF_VF;           end interface
      interface multiply;        module procedure VF_SF;           end interface
      interface multiply;        module procedure VF_VF_VF;        end interface
      interface multiply;        module procedure VF_VF_SF;        end interface
      interface multiply;        module procedure VF_S_VF;         end interface
      interface multiply;        module procedure VF_S;            end interface
      interface multiply;        module procedure S_VF;            end interface

      interface multiply_face;   module procedure face_VF_VF;      end interface
      interface multiply_face;   module procedure face_VF_SF;      end interface
      interface multiply_face;   module procedure face_VF_VF_VF;   end interface
      interface multiply_face;   module procedure face_VF_VF_SF;   end interface
      interface multiply_face;   module procedure face_VF_S_VF;    end interface
      interface multiply_face;   module procedure face_VF_S;       end interface
      interface multiply_face;   module procedure face_S_VF;       end interface

      interface multiply_edge;   module procedure edge_VF_VF;      end interface
      interface multiply_edge;   module procedure edge_VF_SF;      end interface
      interface multiply_edge;   module procedure edge_VF_VF_VF;   end interface
      interface multiply_edge;   module procedure edge_VF_VF_SF;   end interface
      interface multiply_edge;   module procedure edge_VF_S_VF;    end interface
      interface multiply_edge;   module procedure edge_VF_S;       end interface
      interface multiply_edge;   module procedure edge_S_VF;       end interface
