         ...
         if (m%s.gt.1) then
           ...
           elseif (U%is_Face) then
              ...
              case (3); do i=1,m%s
                        ...
                        enddo
              case default; stop 'Error: face must = 1,2,3 in apply_stitches_corners.f90'
              end select
           elseif (U%is_Edge) then
              ...
              case (3); do i=1,m%s
                        ...
                        enddo
              case default; stop 'Error: edge must = 1,2,3 in apply_stitches_corners.f90'
              end select
           else
            write(*,*) 'dir = ',k
            ...
            write(*,*) 'U%Face = ',U%Face
            write(*,*) 'U%Edge = ',U%Edge
            stop 'Error: data type not found in apply_stitches_corners.f90'
           endif
         endif
       end subroutine
       ...
       subroutine app_CC(Umin,Umax,dir,px,py,pz)
         ...
         case default
         stop 'Erorr: dir must = 1,2,3 in applyAllStitches_RF in apply_stitches_corners.f90'
         end select
       end subroutine
