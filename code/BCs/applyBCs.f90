       ...
       interface applyBCs;    module procedure applyBCs_VF_given_BC;        end interface
       interface applyBCs;    module procedure applyBCs_SF_given_BC;        end interface
       ...
       subroutine applyBCs_SF(U,m)
         ...
         call apply_corners(U,m)
       end subroutine

       subroutine applyBCs_VF_given_BC(U,m,BC)
         implicit none
         type(VF),intent(inout) :: U
         type(mesh),intent(in) :: m
         type(VF),intent(inout) :: BC
         call applyBCs(U%x,m)
         call applyBCs(U%y,m)
         call applyBCs(U%z,m)
       end subroutine

       subroutine applyBCs_SF_given_BC(U,m,BC)
         implicit none
         type(SF),intent(inout) :: U
         type(mesh),intent(in) :: m
         type(SF),intent(inout) :: BC
         call apply_faces(U,m)
         call apply_edges(U,m)
         call apply_corners(U,m)
       end subroutine
