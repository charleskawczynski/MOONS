...
def add_modules(g,T,F,priv,real,abstract_interfaces_path):
	...
	g.add_module(m_name)
	g.module[m_name].set_folder_name(__name__.split('.')[1])
	g.module[m_name].set_used_modules(['IO_tools_mod','matrix_free_operators_interfaces_mod','preconditioner_interfaces_mod'])
	...
	g.module[m_name].add_prop(['var_dir','var_name'],'string',priv)
