...
def add_modules(g,T,F,priv,real):
	...
	g.module[m_name].add_prop('FFT_P','FFT_Solver_SF',priv)
	...
	g.module[m_name].add_prop('FFT_cleanB','FFT_Solver_SF',priv)
	g.module[m_name].add_prop(['U_E','temp_E_TF','temp_F1_TF','temp_F2_TF','stresses','temp_CC_TF'],'TF',priv)
	g.module[m_name].add_prop(['sigmaInv_CC','cell_volume','divB','divJ','phi','temp_CC'],'SF',priv)

	g.module[m_name].add_prop(['F'],'VF',priv)
	g.module[m_name].add_prop(['Fnm1'],'VF',priv)
	g.module[m_name].add_prop(['L'],'VF',priv)
	g.module[m_name].add_prop(['J'],'VF',priv)
	g.module[m_name].add_prop(['temp_E'],'VF',priv)
	g.module[m_name].add_prop(['B'],'VF',priv)
	g.module[m_name].add_prop(['Bnm1'],'VF',priv)
	g.module[m_name].add_prop(['B0'],'VF',priv)
	g.module[m_name].add_prop(['Btot'],'VF',priv)
	g.module[m_name].add_prop(['B_interior'],'VF',priv)
	g.module[m_name].add_prop(['temp_F1'],'VF',priv)
	g.module[m_name].add_prop(['temp_F2'],'VF',priv)
	g.module[m_name].add_prop(['jCrossB'],'VF',priv)
	g.module[m_name].add_prop(['Bstar'],'VF',priv)
	g.module[m_name].add_prop(['dB0dt'],'VF',priv)
	g.module[m_name].add_prop(['sigmaInv_edge'],'VF',priv)
	g.module[m_name].add_prop(['J_interior'],'VF',priv)
	g.module[m_name].add_prop(['curlUCrossB'],'VF',priv)
	g.module[m_name].add_prop(['cell_inverse_area'],'VF',priv)
	g.module[m_name].add_prop(['CC_VF_fluid'],'VF',priv)
	g.module[m_name].add_prop(['CC_VF_sigma'],'VF',priv)
	g.module[m_name].add_prop(['temp_CC_VF'],'VF',priv)
