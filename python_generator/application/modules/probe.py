...
def add_modules(g,T,F,priv,real):
	...
	g.module[m_name].add_prop('tec_dir'              ,'string',priv)
	g.module[m_name].add_prop('tec_name'             ,'string',priv)
	...
	g.module[m_name].add_prop('abs_d_data_dt'        ,real,priv)
	g.module[m_name].add_prop('abs_d_data_dt_by_dmax',real,priv)
