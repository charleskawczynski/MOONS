...
\newcommand{\thetaAngle}{20} % 0 < theta < 90 : Controls top to bottom rotation
...
% Edge fields:
	...
	\draw[\arrR,anchor=east,line width=\wArr](\OR,\OR+\dy/2-\arrowL) -- ++(0,\arrowL)                                                               node[above=.1,anchor=west]{\EQS $J_{y,i-\frac{1}{2},j,k-\frac{1}{2}}$};
...
% Face fields:
	...
	\draw[line width=\wArr,\arrR] (\CCx-\dx/2-\arrowL,\CCy) -- ++(\arrowL,0)                     node[left=0.1,anchor=west] {\EQS $(u,B_x)_{i-\frac{1}{2},j,k}$};
