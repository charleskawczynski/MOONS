...
\begin{equation}
	\boxed{
	u_i (j \times B)_i
	= u_i B_j \frac{\PD}{\PD x_j} \frac{B_i}{\M} - u_i \frac{\PD}{\PD x_i} \frac{B_j^2}{2 \M}
	, \qquad E_m = \frac{B_j^2}{2 \M}
	}
\end{equation}
Which we may write in vector notation as
\begin{equation}
	\boxed{
	\U \DOT (\J \CROSS \B) = \U \DOT \left[\B \DOT \DEL \left( \H \right) \right] - (\U \DOT \DEL) E_m
	,\qquad
	E_m = \frac{\B^2}{2 \M}
	}
\end{equation}
...
\begin{equation}
	...
	+ \underbrace{u_i B_j \frac{\PD}{\PD x_j} \frac{B_i}{\M}}_
...
\begin{equation}
	...
	+ \underbrace{ \nu \frac{\PD^2 E_K}{\PD x_j^2} }_{\substack{\text{Diffusion } \MC D_K \\ \text{of $E_K$ }}}
