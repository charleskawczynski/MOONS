...
When writing thesis, refer to http://fire.pppl.gov/fpa\_annual\_meet.html
...
\section{Today}
- Perform more comparisons of numerical experiment matrix
...
- Finish incorporating string into MOONS so that it'll run on DOE cluster

- Test MOONS on DOE cluster.

- Get oil change on car.
