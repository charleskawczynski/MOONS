...
- Brainstorm sims to start (only running Shercliff flow on my comp and only 1 sigma comparison on workstation).

- Baby steps towards BEM.

- Complex geometry - do some more testing.

- Read Bandaru paper, get a better idea of BC paper for JCP.

- Develop organization of prospectus document

- Brainstorm parameters to use for BC sim.
