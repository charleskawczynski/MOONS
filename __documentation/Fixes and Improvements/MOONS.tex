...
\item Start presentation for Thursday.
...
\begin{itemize}
\setlength\itemsep{-1em}
\item put check back into coordinate stretch parameter matching
\item in sim params, change post-process only to skip solver loop and include a "post process" logical
...
\item remove apply\_stitches\_mod from ops\_advect.f90 and momentum\_solver.f90
\end{itemize}
