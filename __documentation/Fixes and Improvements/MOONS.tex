...
\section{Culprits of divU not zero for duct flows}

- zeroWallCoincidentBoundariesVF for F (NOT U, which contains the BCs for U)

- zeroGhostPoints after div(divU,Ustar,g)
