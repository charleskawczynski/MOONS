...
\begin{itemize}
\setlength\itemsep{-1em}
\item Test mpi send / receive for 2D array on Hoffman2
\item Test mpi send / receive for float on Hoffman2
...
% 
\item Follow up with Rafaella about Sublime Text
\item clean up mesh generation with 'new\_case' in coordinate\_stretch\_param\_match
\item Clean up files not compiled in code directory
\item respond to soccer email
