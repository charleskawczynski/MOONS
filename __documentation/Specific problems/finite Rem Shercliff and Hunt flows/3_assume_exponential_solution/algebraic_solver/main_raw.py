...
eq4 = n*B_x -( - K*nu_m*B_x + u*( BBx*i*theta +B_z0*i*beta) +B_y* Y +B_z *Z -  UBx*i*theta*B_x + v *MY +w *MZ)
eq5 = n*B_y -( - K*nu_m*B_y + v*( BBx*i*theta +B_z0*i*beta)                 -  UBx*i*theta*B_y)
eq6 = n*B_z -( - K*nu_m*B_z + w*( BBx*i*theta +B_z0*i*beta)                 -  UBx*i*theta*B_z)
