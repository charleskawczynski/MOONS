...
% \section{Maximum velocity and magnetic fields}
% The maximum velocity and magnetic field may be found by taking the derivative, and setting it equal to zero...
% \begin{equation}\begin{aligned}
% \frac{1}{a} = \frac{M }{\sinh(M a)}, \qquad y_{max,B} = 0 \\
% \sinh(M y) = 0, \qquad y_{max,B} = 0 \\
% M = B_z^0 \sqrt{\frac{\sigma}{\rho \nu}} \\
% \end{aligned} \end{equation}
