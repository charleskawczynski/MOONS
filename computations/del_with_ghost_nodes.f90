      ...
      subroutine diff(dfdh,f,dh1,dh2,n,diffType,s,genType)
        ...
        case (1); call collocatedAssign(dfdh,f,dh1,dh2,n,s,1)    ! Collocated CellCenter derivative
        case (2); call collocatedAssign(dfdh,f,dh2,dh1,n,s,0)    ! Collocated Node derivative
        case (3); call staggeredAssign(dfdh,f,dh1,s,1)           ! Cell centered staggered derivative
        case (4); call staggeredAssign(dfdh,f,dh2,s,0)           ! Node centered staggered derivative
        end select
        case (2) ! add
        select case (diffType)
        case (1); call collocatedAdd(dfdh,f,dh1,dh2,n,s,1)       ! Collocated CellCenter derivative
        case (2); call collocatedAdd(dfdh,f,dh2,dh1,n,s,0)       ! Collocated Node derivative
        case (3); call staggeredAdd(dfdh,f,dh1,s,1)              ! Cell centered staggered derivative
        case (4); call staggeredAdd(dfdh,f,dh2,s,0)              ! Node centered staggered derivative
        end select
        case (3) ! subtract
        select case (diffType)
        case (1); call collocatedSubtract(dfdh,f,dh1,dh2,n,s,1)  ! Collocated CellCenter derivative
        case (2); call collocatedSubtract(dfdh,f,dh2,dh1,n,s,0)  ! Collocated Node derivative
        case (3); call staggeredSubtract(dfdh,f,dh1,s,1)         ! Cell centered staggered derivative
        case (4); call staggeredSubtract(dfdh,f,dh2,s,0)         ! Node centered staggered derivative
        end select
        case (4) ! multiply
        select case (diffType)
        case (1); call collocatedMultiply(dfdh,f,dh1,dh2,n,s,1)  ! Collocated CellCenter derivative
        case (2); call collocatedMultiply(dfdh,f,dh2,dh1,n,s,0)  ! Collocated Node derivative
        case (3); call staggeredMultiply(dfdh,f,dh1,s,1)         ! Cell centered staggered derivative
        case (4); call staggeredMultiply(dfdh,f,dh2,s,0)         ! Node centered staggered derivative
        end select
        case (5) ! divide
        select case (diffType)
        case (1); call collocatedDivide(dfdh,f,dh1,dh2,n,s,1)    ! Collocated CellCenter derivative
        case (2); call collocatedDivide(dfdh,f,dh2,dh1,n,s,0)    ! Collocated Node derivative
        case (3); call staggeredDivide(dfdh,f,dh1,s,1)           ! Cell centered staggered derivative
        case (4); call staggeredDivide(dfdh,f,dh2,s,0)           ! Node centered staggered derivative
        end select
        case default
