      ...
      interface divide;        module procedure SF_SF;           end interface
      interface divide;        module procedure SF_SF_SF;        end interface
      interface divide;        module procedure SF_S_SF;         end interface
      interface divide;        module procedure SF_S;            end interface
      interface divide;        module procedure S_SF;            end interface
      ...
      interface divide;        module procedure VF_VF_SF;        end interface
      interface divide;        module procedure VF_S_VF;         end interface
      interface divide;        module procedure VF_S;            end interface
      interface divide;        module procedure S_VF;            end interface

      interface divide_face;   module procedure face_VF_VF;      end interface
      interface divide_face;   module procedure face_VF_SF;      end interface
      interface divide_face;   module procedure face_VF_VF_VF;   end interface
      interface divide_face;   module procedure face_VF_VF_SF;   end interface
      interface divide_face;   module procedure face_VF_S_VF;    end interface
      interface divide_face;   module procedure face_VF_S;       end interface
      interface divide_face;   module procedure face_S_VF;       end interface

      interface divide_edge;   module procedure edge_VF_VF;      end interface
      interface divide_edge;   module procedure edge_VF_SF;      end interface
      interface divide_edge;   module procedure edge_VF_VF_VF;   end interface
      interface divide_edge;   module procedure edge_VF_VF_SF;   end interface
      interface divide_edge;   module procedure edge_VF_S_VF;    end interface
      interface divide_edge;   module procedure edge_VF_S;       end interface
      interface divide_edge;   module procedure edge_S_VF;       end interface
