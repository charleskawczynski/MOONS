      module RF_add_product_mod
      use RF_mod
      implicit none
      private

      public :: add_product
      public :: add_product_face
      public :: add_product_edge
      ...
      interface add_product;        module procedure SF_SF;           end interface
      interface add_product;        module procedure SF_SF_SF;        end interface
      interface add_product;        module procedure SF_S_SF;         end interface
      interface add_product;        module procedure SF_S;            end interface
      interface add_product;        module procedure S_SF;            end interface

      interface add_product;        module procedure VF_VF;           end interface
      interface add_product;        module procedure VF_SF;           end interface
      interface add_product;        module procedure VF_VF_VF;        end interface
      interface add_product;        module procedure VF_VF_SF;        end interface
      interface add_product;        module procedure VF_S_VF;         end interface
      interface add_product;        module procedure VF_S;            end interface
      interface add_product;        module procedure S_VF;            end interface

      interface add_product_face;   module procedure face_VF_VF;      end interface
      interface add_product_face;   module procedure face_VF_SF;      end interface
      interface add_product_face;   module procedure face_VF_VF_VF;   end interface
      interface add_product_face;   module procedure face_VF_VF_SF;   end interface
      interface add_product_face;   module procedure face_VF_S_VF;    end interface
      interface add_product_face;   module procedure face_VF_S;       end interface
      interface add_product_face;   module procedure face_S_VF;       end interface

      interface add_product_edge;   module procedure edge_VF_VF;      end interface
      interface add_product_edge;   module procedure edge_VF_SF;      end interface
      interface add_product_edge;   module procedure edge_VF_VF_VF;   end interface
      interface add_product_edge;   module procedure edge_VF_VF_SF;   end interface
      interface add_product_edge;   module procedure edge_VF_S_VF;    end interface
      interface add_product_edge;   module procedure edge_VF_S;       end interface
      interface add_product_edge;   module procedure edge_S_VF;       end interface
