     ...
     subroutine init_SP(SP,DT)
       ...
       SP%FCL%export_vorticity_streamfunction    = T
       ...
       call init(SP%EF%unsteady_2D   ,T,T,1,10,3)
       call init(SP%EF%unsteady_3D   ,F,F,1,10,3)
       ...
       time                          = 10.0_cp
       ! t_c = 0.00790207929237_cp ! for plasma disruption
       ! dtime                         = 1.0_cp*pow(-2)
       dtime                         = 1.0_cp*pow(-5)
       ...
       SP%DP%Re                      = 12.0_cp*pow(6)
       SP%DP%Ha                      = 26.0_cp*pow(2)
       SP%DP%Rem                     = 2.0_cp
       ...
       call init(SP%VS%U%unsteady_planes  ,T,3,2,'1')
