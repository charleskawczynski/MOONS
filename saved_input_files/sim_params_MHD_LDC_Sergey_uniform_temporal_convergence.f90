     ...
     subroutine init_SP(SP,DT)
       ...
       time                          = 1.0_cp
       ! dtime                         = 1.0_cp*pow(-2)
       ! dtime                         = 1.0_cp*pow(-2)*0.5_cp**(2.0_cp)
       dtime                         = 1.0_cp*pow(-4)*0.5_cp**(3.0_cp)
