     ...
     subroutine define_mesh_SP(SP)
       ...
       call add_base(SP%MP_mom,seg_1d(1,'grid_Roberts_B'  ,64,-1.0_cp,1.0_cp))
       call add_base(SP%MP_mom,seg_1d(2,'grid_Roberts_B'  ,64,-1.0_cp,1.0_cp))
       ...
       call add_ext(SP%MP_ind,seg_1d(1,'ext_Roberts_B_IO' ,6,0.05_cp))
       call add_ext(SP%MP_ind,seg_1d(2,'ext_Roberts_B_IO' ,6,0.05_cp))
     end subroutine
     ...
     subroutine init_SP(SP,DT)
       ...
       SP%SCP%finite_Rem                 = F ! Ensures all dt are equal to coupled%dt
